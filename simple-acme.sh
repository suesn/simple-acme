...
menu() {
    ...
    echo "#############################################################"
    echo ""
    echo " ${GREEN}1.${PLAIN} 安装 Acme.sh 域名证书申请脚本"
    echo " ${GREEN}2.${PLAIN} ${RED}卸载 Acme.sh 域名证书申请脚本${PLAIN}"
    echo " -------------"
    echo " ${GREEN}3.${PLAIN} 申请单域名证书 ${YELLOW}(80端口申请)${PLAIN}"
    echo " -------------"
    echo " ${GREEN}9.${PLAIN} 切换证书颁发机构"
    echo " -------------"
    echo " ${GREEN}0.${PLAIN} 退出脚本"
    echo ""
